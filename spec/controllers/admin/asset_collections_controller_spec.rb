...
describe Admin::AssetCollectionsController do
  ...
  describe "GET new" do
    before(:each) do
      AssetCollection.stub(:new).and_return(asset_collection.as_new_record)
    end
  ...
  describe "POST create" do
    ...
    before(:each) do
      ...
      AssetCollection.stub(:new).and_return(asset_collection)
    end
  ...
  describe "PUT update" do
    ...
    it "should update updated_by attribute" do
      asset_collection.should_receive(:updated_by=).with(current_admin_user)
      do_put
    end
