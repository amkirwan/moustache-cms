  ...
  module CreatedUpdatedBy
    ...
    module ClassMethods
      def created_updated(inverse)
        ...
        belongs_to :created_by, :class_name => "MoustacheCms::User", :inverse_of => created.to_sym
        belongs_to :updated_by, :class_name => "MoustacheCms::User", :inverse_of => updated.to_sym
      end
    end
