module Admin::PagesHelper  
  ...
  def can_destroy_page?(page)
    ...
    if can? :destroy, page 
      link_to "<div class=\"delete_page\"></div>".html_safe, admin_page_path(page), :method => :delete, :confirm => "Are you sure you want to delete the page #{page.title}", :class => "delete", :remote => true
    end
  end
