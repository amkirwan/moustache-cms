...
Scenario: Given I am logged in as an admin then I can edit a layout
  ...
  And the "layout[name]" field within "div#edit_layout" should contain "foobar"
  And the "layout[content]" field within "div#edit_layout" should contain "Hello, World!"
  ...
  And the "layout[name]" field within "div#edit_layout" should contain "baz"
  And the "layout[content]" field within "div#edit_layout" should contain "Hello, <b>World!</b>"
