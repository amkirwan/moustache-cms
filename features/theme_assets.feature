...
Background: Login to site and create theme assets
  ...
  @wip @javascript @delete_theme_collection_from_index
  ...
  @javascript @create_theme_asset_js
  ...
  @javascript @create_theme_asset_css
  ...
  @javascript @delete_theme_asset_from_index
